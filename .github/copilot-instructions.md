# Sumapap - GitHub Copilot Instructions

This document provides guidance for working with code in the Sumapap project.
...
- All types should be public by default, but types in `.Internal` namespaces require a specific XML doc comment on ALL members.

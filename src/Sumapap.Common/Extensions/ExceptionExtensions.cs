...
namespace Sumapap.Common.Extensions
{
    ...
    {
        public static string GetDeepMessage(this Exception exception, bool writeNewLine = true) => exception.GetDeepMessageInternal(writeNewLine);

        private static string GetDeepMessageInternal(this Exception exception, bool writeNewLine = true, int level = 0)
        {
